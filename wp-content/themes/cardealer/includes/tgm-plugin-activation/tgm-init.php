	...
	function cardealer_tgmpa_plugin_list() {
		...
		$required_plugins = array(
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-helper-library-3.5.0.zip' ),
				'required'           => true,
			...
			array(
				...
				'slug'               => 'revslider',
				'source'             => cardealer_tgmpa_plugin_path( 'revslider-6.5.9.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
			...
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'advanced-custom-fields-pro-5.10.2.zip' ),
				'required'           => true,
				'force_activation'   => false,
				'force_deactivation' => false,
		...
		if ( ! $is_setup_wizard || ( $is_setup_wizard && array_key_exists( $page_builder, $page_builders ) && 'wpbakery' === $page_builder ) ) {
			$plugins[] = array(
				...
				'slug'               => 'js_composer',
				'source'             => cardealer_tgmpa_plugin_path( 'js_composer-6.7.0.zip' ),
		...
		$recommended_plugins = array(
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-front-submission-1.8.1.zip' ),
				'required'           => false,
				'force_activation'   => false,
				'force_deactivation' => false,
				'details_url'        => '',
			...
			array(
				'name'               => esc_html__( 'Car Dealer - PDF Generator', 'cardealer' ),
				'slug'               => 'cardealer-pdf-generator',
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-pdf-generator-1.0.0.zip' ),
				'required'           => false,
				'force_activation'   => false,
				'force_deactivation' => false,
				'details_url'        => '',
			...
			array(
				...
				'source'             => cardealer_tgmpa_plugin_path( 'cardealer-vinquery-import-1.5.0.zip' ),
				'required'           => false,
				'force_activation'   => false,
				'force_deactivation' => false,
				'details_url'        => '',
