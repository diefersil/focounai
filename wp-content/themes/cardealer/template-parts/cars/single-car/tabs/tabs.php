		...
		<div id="tabs">
			...
			<ul class="tabs">
				...
				foreach ( $vehicle_tabs as $key => $vehicle_tab ) {
					...
					?>
					<li id="tab-title-<?php echo esc_attr( $key ); ?>" class="<?php echo esc_attr( $key ); ?>_tab <?php echo esc_attr( 1 === $tab_sr ? ' active' : '' ); ?>" data-tabs="tab-<?php echo esc_attr( $key ); ?>">
			...
			<?php foreach ( $vehicle_tabs as $key => $vehicle_tab ) : ?>
				<div id="tab-<?php echo esc_attr( $key ); ?>" class="tabcontent">
					<?php
