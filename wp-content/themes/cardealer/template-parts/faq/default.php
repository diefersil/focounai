...
<div id="tabs" class="tabs_wrapper">
	<?php if ( $pgs_category_count > 1 || 'all' === $pgs_faq_type ) { ?>
	<ul class="tabs text-center">
		...
		foreach ( $faq_page_tabs_data as $faq_page_query ) {
			...
			?>
			<li data-tabs="tab_<?php echo esc_attr( $faq_page_query['slug'] ); ?>" class="<?php esc_attr( $activ ); ?>"><span aria-hidden="true"></span><?php echo esc_html( $faq_page_query['title'] ); ?></li>
			<?php
