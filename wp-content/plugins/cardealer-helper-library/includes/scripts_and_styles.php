...
if ( ! function_exists( 'cdhl_admin_enqueue_scripts' ) ) {
	...
	function cdhl_admin_enqueue_scripts( $hook ) {
		...
		wp_register_script( 'cdhl-google-maps-apis', 'https://maps.googleapis.com/maps/api/js?key=' . $google_maps_api_key . '&libraries=drawing,places', array(), CDHL_VERSION, true );
