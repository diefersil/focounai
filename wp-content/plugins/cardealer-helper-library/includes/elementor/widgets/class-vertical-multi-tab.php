 ...
 * @since 5.0.0
 */
class Vertical_Multi_Tab extends Widget_Controller {
	 ...
	 * @var string
	 */
	protected $widget_slug = 'vertical-multi-tab';
	 ...
	 * @var array
	 */
	protected $keywords = array( 'vertical', 'multi', 'tab' );
	...
	public function get_title() {
		return esc_html__( 'Potenza Vertical Multi Tab', 'cardealer-helper' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'advertise_img',
			[
				'label'       => esc_html__( 'Advertise banner image', 'cardealer-helper' ),
