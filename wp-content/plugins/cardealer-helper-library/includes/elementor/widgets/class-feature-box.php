 ...
 * @since 5.0.0
 */
class Feature_Box extends Widget_Controller {
	 ...
	 * @var string
	 */
	protected $widget_slug = 'feature-box';
	 ...
	 * @var array
	 */
	protected $keywords = array( 'feature', 'box' );
	...
	public function get_title() {
		return esc_html__( 'Potenza Feature Box', 'cardealer-helper' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .feature-box.feature-border.round-icon h6:before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .feature-box h6' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .feature-box.style-8 .icon i:before'  => 'color: {{VALUE}};',
					'{{WRAPPER}} .feature-box.style-10 .icon i:before' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .feature-box i'                  => 'background: {{VALUE}};',
					'{{WRAPPER}} .feature-box.round-border .icon' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .feature-box.box-hover:hover i'                      => 'color: {{VALUE}};',
					'{{WRAPPER}} .feature-box.style-8.box-hover:hover .icon i:before' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .feature-box.box-hover:hover i'                  => 'background: {{VALUE}};',
					'{{WRAPPER}} .feature-box.round-border.box-hover:hover .icon' => 'border-color: {{VALUE}};',
				],
			]
		);
