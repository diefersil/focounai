...
if ( ! function_exists( 'cdhl_compare_column_fields' ) ) {
	...
	function cdhl_compare_column_fields() {
		...
		if ( ! empty( $vehicle_compare_fields_options['Selected'] ) ) {
			...
			$vehicle_cat = array_search('vehicle_cat', $cars_taxes);
			$car_features_options = array_search('car_features_options', $cars_taxes);
			unset($cars_taxes[$vehicle_cat]);
			unset($cars_taxes[$car_features_options]);
			$car_vehicle_review_stamps = array_search('car_vehicle_review_stamps', $cars_taxes);
			if ( isset($car_vehicle_review_stamps) && ! empty($car_vehicle_review_stamps) ) {
