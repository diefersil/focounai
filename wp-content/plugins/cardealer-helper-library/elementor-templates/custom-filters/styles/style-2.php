<?php
/**
 * Custom filters Elementor widget template style 2
 *
		...
		foreach ( $cars_filters as $filters ) {
			...
			<div class="col-sm-6">
				...
				<div class="selected-box">
					<select data-uid="<?php echo esc_attr( $this->get_id() ); ?>" id="sort_<?php echo esc_attr( $filters . '_' . $this->get_id() ); ?>" data-id="<?php echo esc_attr( $filters ); ?>" class="selectpicker custom-filters-box col-6 cd-select-box">
